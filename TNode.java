...
//need to figure out some way to delete things...

}}}
//ID first node, break first node connection to parent, ID parent of free slot, this.add(firstnode).
//My solution - after discovering an empty space, find the next thing that is filled. Take it out of its place, copy-isolate it in its own variable, delete the original copy, and add the copy-isolated version into where that empty was. Rinse and repeat until complete.
